...
Feature: Spec Page scenarios
  ...
  When user in SpecPage calls "spec" API with "post" method at endpoint "addSpec" 
  ...
  When user in SpecPage calls "spec" API with "patch" method at endpoint "actionOnSpec" and specId "specId"
  ...
  When user in SpecPage calls "spec" API with "DELETE" method at endpoint "actionOnSpec" and specId "specId"
  Then the SpecPage API call success with status code 200
